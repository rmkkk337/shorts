...
export default function Login() 
{
  ...
  const handleSubmit = () => 
  {
    ...
    axios
      .post(
        'http://ec2-13-53-80-251.eu-north-1.compute.amazonaws.com/auth/login',
        {
          email: email,
          password: password,
        },
      ...
      .then((response) => 
      {
        ...
        {
          axios.get(`http://ec2-13-53-80-251.eu-north-1.compute.amazonaws.com/user/`, { withCredentials: true }).then((response) => 
          {
